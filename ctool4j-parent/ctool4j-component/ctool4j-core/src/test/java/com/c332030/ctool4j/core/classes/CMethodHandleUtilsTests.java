 ...
 *   <li>依据 {@code CMethodHandleUtils} 的能力划分（{@code getGetterHandle} 原始签名缓存与 {@code getGetterHandleAsType} 统一 Object 签名并存，设计见 {@link CMethodHandleUtils} 指向的设计文档）：两者分别覆盖</li>
