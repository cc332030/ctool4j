...
public class CAssertTests {
    ...
    public void validCharSequence() {
        ...
        CAssert.valid("abc", "msg");
        CAssert.valid("abc", () -> "msg");
        CAssert.notValid("", "msg");
        CAssert.notValid("   ", () -> "msg");
        CAssert.notValid((CharSequence) null, "msg");

        // 空白不满足 valid、非空白不满足 notValid
        Assertions.assertThrowsExactly(CBusinessException.class, () -> CAssert.valid("   ", "msg"));
        Assertions.assertThrowsExactly(CBusinessException.class, () -> CAssert.notValid("abc", "msg"));
    ...
    public void validCollection() {
        ...
        CAssert.valid(CList.of(1), () -> "msg");
        CAssert.notValid(CList.of(), "msg");
        CAssert.notValid((Collection<?>) null, () -> "msg");

        // 空不满足 valid、非空不满足 notValid
        Assertions.assertThrowsExactly(CBusinessException.class, () -> CAssert.valid(CList.of(), "msg"));
    ...
    public void validMap() {
        ...
        CAssert.valid(CMap.of("a", 1), () -> "msg");
        CAssert.notValid(new HashMap<>(), "msg");
        CAssert.notValid((Map<?, ?>) null, () -> "msg");

        // 空不满足 valid、非空不满足 notValid
        Assertions.assertThrowsExactly(CBusinessException.class, () -> CAssert.valid(new HashMap<>(), "msg"));
        Assertions.assertThrowsExactly(CBusinessException.class, () -> CAssert.notValid(CMap.of("a", 1), "msg"));
