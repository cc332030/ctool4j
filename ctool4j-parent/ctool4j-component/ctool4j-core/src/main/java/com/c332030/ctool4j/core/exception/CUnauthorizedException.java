 ...
 * HTTP 401（Unauthorized）响应（见 ctool4j-web 的 {@code CUnauthorizedExceptionHandler}）。</p>
 *
 * <h2>能力目录</h2>
 * <ul>
 *   <li>继承 {@code CException}，标注 {@code @StandardException}（由 Lombok 生成标准异常构造集合：无参/消息/原因/消息+原因）。</li>
 *   <li>不携带错误码：业务码与 HTTP 状态由统一处理器按 401 判定，避免每个抛出点各自指定码。</li>
 * </ul>
 * <h2>兜底设计</h2>
 * <table border="1">
