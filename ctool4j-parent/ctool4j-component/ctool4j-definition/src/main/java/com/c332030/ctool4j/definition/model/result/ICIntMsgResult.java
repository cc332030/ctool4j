...
/**
 * <p>
 * Description: ICIntMsgResult
 * </p>
 *
 * <h2>能力目录</h2>
 * <p>{@code ICIntMsgResult} 为整型编码消息数据结果契约接口。</p>
 * <ul>
 *   <li>组合语义：编码类型固定为 Integer</li>
 *   <li>继承关系：extends ICResult&lt;Integer, DATA&gt;, ICCodeMsgDataResult&lt;Integer, DATA&gt;</li>
 * </ul>
 * <h2>设计要点</h2>
 * <ul>
