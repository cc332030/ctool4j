 ...
 * <h2>设计思路</h2>
 * <ul>
 *   <li>验证文件名/类型/MIME的各条路径与边界。</li>
 * </ul>
 * <h2>设计依据</h2>
 * <ul>
 *   <li>依据功能设计对文件名/类型/MIME的约定。</li>
 *   <li>依据测试方法（等价类/边界/分支覆盖）。</li>
 * </ul>
 * <h2>覆盖场景与未覆盖</h2>
 * <ul>
 *   <li>覆盖：文件名/类型/MIME的正常、边界与异常路径。</li>
 *   <li>未覆盖：真实容器/框架集成场景。</li>
 * </ul>
 * <h2>文件工具</h2>
 * <ul>
 *   <li>1.1 验证文件名/类型/MIME（对应测试方法 1.1-1.26）</li>
 * </ul>
 *
 * @since 2026/8/14
 * @version 1.0
...
class CFileUtilsTests {
    ...
    // ---------- getFileName ----------
        ...
        /**
         * 对应测试用例 1.1：验证文件名/类型/MIME（对应测试方法 1.1-1.26）
         */
    @Test
