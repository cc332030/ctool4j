 ...
 * @author c332030
 * @since 2026/9/9
 * @see "doc/design/spring/CIpUtilsTests.adoc"
 */
class CIpUtilsTests {
    ...
    /**
     * IPv6 规则不产生异常，且 v4 地址不命中 IPv6 规则
     */
    @Test
    ...
    /**
     * IPv4 全 255 地址（0xFFFFFFFF，验证哨兵 INVALID_IP=-1 不误判）
     */
    @Test
    ...
    /**
     * CIDR 网络地址非规范起点（如 192.168.1.5/24），按输入 IP 与掩码由 hutool 计算区间，仍命中该 IP
     */
    @Test
