 ...
 *
 * <h2>能力目录</h2>
 * <p>{@code CSecurityResponseWriter}（{@code @UtilityClass}）是安全侧错误响应的<b>javax 侧入口</b>：
 * 收 javax 的 {@link HttpServletResponse}，包装成抽象层响应后委托
 ...
 * <h2>适用范围</h2>
 * <ul>
 *   <li>javax（Spring Boot 2.x / Servlet 4.0）工程中，过滤器、处理器等只有 javax 响应对象、
