 ...
 *     <li>标准 jakarta.validation 注解（@NotNull/@NotBlank/@NotEmpty，按类型分别标注）</li>
 ...
 *   <li>对比 @CRequired（被测）与标准 jakarta.validation 注解、手工 CValidUtils 三类实现，贴近真实使用。</li>
...
public class CRequiredValidatorPerfTests {
    ...
    /**
     * 标准 jakarta.validation 注解标注的待校验 Bean（对应 CRequiredBean，按类型选注解）
     */
    @Data
    @NoArgsConstructor
    ...
    /**
     * 标准 jakarta.validation 注解校验（常规）：@NotNull/@NotBlank/@NotEmpty
     */
