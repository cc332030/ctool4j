 ...
 *
 * <h2>能力目录</h2>
 * <p>{@code CWebMvcConfigurer} 为 web MVC 配置，{@code @Configuration} + {@code @AllArgsConstructor} + 实现 {@code WebMvcConfigurer}， 构造注入 {@code Collection&lt;ICSpringHandlerInterceptor&gt;} 与 {@code CSpringJacksonConfig}。</p>
 * <p>核心方法：</p>
 * <ul>
 ...
 *   </tr>
 *   <tr>
 *     <td>无 {@code ICSpringHandlerInterceptor}</td>
 ...
 * <p><b>拦截器注册</b></p>
 * <ul>
 *   <li>收集容器中所有 {@code ICSpringHandlerInterceptor} bean，统一注册。</li>
 * </ul>
...
public class CWebMvcConfigurer implements WebMvcConfigurer {
    ...
    Collection<ICSpringHandlerInterceptor> icHandlerInterceptors;
     ...
     * 注册所有处理器拦截器
     * <ul>
     *   <li>{@code addInterceptors(InterceptorRegistry registry)}：将全部 {@code ICSpringHandlerInterceptor} 注册到拦截器链</li>
     * </ul>
     *
