 ...
 *
 * <h2>能力目录</h2>
 * <p>{@code ICLogLevelError}（extends {@code ICLogLevel}）以 default 方法固定返回日志级别 {@code Level.ERROR}。</p>
 * <h2>兜底设计</h2>
 * <p>无（default 方法固定返回值）。</p>
 * <h2>适用范围</h2>
 * <ul>
 *   <li>声明某组件的日志级别为 ERROR。</li>
 * </ul>
 * <h2>不适用与边界场景</h2>
 * <ul>
 *   <li>不用于动态级别调整。</li>
 ...
 * <p><b>固定级别</b></p>
 * <ul>
 *   <li>重写 {@code getLevel()} 默认返回 {@code Level.ERROR}。</li>
 * </ul>
 *
 * @since 2026/3/20
 * @version 1.0
