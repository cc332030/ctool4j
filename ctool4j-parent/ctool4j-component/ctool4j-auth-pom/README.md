...
| 子模块 | 定位 |
|--------|------|
| `ctool4j-auth-base` | 认证基础：`CAuthUtils`、`CAuthConfig`、`CSessionConfig`、`ICJwtInfo`、`ICSession`、`CAbstractBaseAuthFilter`、`CAbstractBaseSessionService`、`CAbstractSessionMockConfig` |
