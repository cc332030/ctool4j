 ...
 *
 * <h2>能力目录</h2>
 * <p>{@code CHttpServletRequest} 是 {@link CHttpRequest} 在 <b>javax</b> 侧的落地（适配器）：
 * 持有 {@code javax.servlet.http.HttpServletRequest}，把接口声明的公共方法逐个转发给它。</p>
 ...
 * <h2>适用范围</h2>
 * <ul>
 *   <li>运行在 javax（Spring Boot 2.x / Servlet 4.0）容器下、需要面向 {@link CHttpRequest} 编写公共代码的场景。</li>
 * </ul>
 *
 * <h2>已知限制与取舍</h2>
 * <ul>
 *   <li>只覆盖两边公共面：Cookie 已以 {@link ICCookie}、会话已以 {@link ICHttpSession} 纳入；javax 特有的
...
public final class CHttpServletRequest implements CHttpRequest {
     ...
     * @return 底层 javax 请求；入参为 null 时返回 null
