 ...
 *
 * <h2>能力目录</h2>
 * <p>{@code CFilterAdapter} 是 {@link CFilter} 在 <b>javax</b> 侧的落地（适配器）：
 * 实现 {@code javax.servlet.Filter}，把容器的 Servlet 请求/响应与过滤器链转换成本抽象层的类型后，
 ...
 * <h2>适用范围</h2>
 * <ul>
 *   <li>运行在 javax（Spring Boot 2.x / Servlet 4.0）容器下、需要注册 {@link CFilter} 实现为过滤器的场景。</li>
 * </ul>
 *
 * <h2>已知限制与取舍</h2>
 * <ul>
