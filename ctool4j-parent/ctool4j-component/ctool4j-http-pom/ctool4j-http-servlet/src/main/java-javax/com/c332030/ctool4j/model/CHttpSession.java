 ...
 *
 * <h2>能力目录</h2>
 * <p>{@code CHttpSession} 是 {@link ICHttpSession} 在 <b>javax</b> 侧的落地（适配器）：
 * 持有 {@code javax.servlet.http.HttpSession}，把接口声明的方法逐个转发给它。</p>
 ...
 * <h2>适用范围</h2>
 * <ul>
 *   <li>运行在 javax（Spring Boot 2.x / Servlet 4.0）容器下、需要面向 {@link ICHttpSession} 编写公共代码的场景。</li>
 * </ul>
 *
 * <h2>已知限制与取舍</h2>
 * <ul>
