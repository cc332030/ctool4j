 ...
 *
 * <h2>能力目录</h2>
 * <p>{@code CAccessDeniedHandler} 是访问拒绝处理的<b>jakarta 侧适配器</b>：实现 Spring Security 的
 * {@link AccessDeniedHandler}（其签名固定为 jakarta Servlet 类型），把请求/响应包装成抽象层对象后，
 ...
 * <h2>适用范围</h2>
 * <ul>
 *   <li>jakarta（Spring Boot 2.x / Servlet 4.0）工程中的访问拒绝统一处理，由 {@code CSecurityConfiguration} 自动装配。</li>
 * </ul>
 *
 * <h2>不适用与边界场景</h2>
 * <ul>
