 ...
 *
 * <h2>能力目录</h2>
 * <p>{@code CRequestUtils} 是请求工具在 <b>javax</b> 侧的落地：<b>只保留必须接触容器的方法</b>——
 ...
 *   {@code RequestDispatcher.ERROR_STATUS_CODE} 在两侧分别是 {@code javax.servlet.error.status_code} 与
 *   {@code jakarta.servlet.error.status_code}，只能落在两侧同名类上（切模块即切值）。</li>
 *   <li><b>同名同构</b>：本类在两侧适配模块中同包同名（本份承接 javax 侧），使用方切换依赖模块即可切换容器。</li>
 * </ul>
 *
 * <h2>兜底设计</h2>
 * <table border="1">
