 ...
 *
 * <h2>能力目录</h2>
 * <p>{@code ICSpringResponseBodyAdvice} 是基层契约 {@link ICResponseBodyAdvice} 在 <b>javax</b> 侧的落地（适配接口）：
 ...
 *   <li><b>同名接口</b>：本接口在 {@code src/main/java-javax} 与 {@code src/main/java-jakarta} 两份中<b>同包同名</b>，
