 ...
 * 实现 {@code ICHandlerInterceptor}（{@code ctool4j-spring-jakarta} 提供的抽象层版，继承 Spring {@code HandlerInterceptor}）。</p>
 ...
 * <p><b>用抽象层类型，无需解包</b></p>
 * <ul>
 *   <li>方法签名取 {@link CHttpRequest}/{@link CHttpResponse}：适配器（{@code ICHandlerInterceptor}）已把容器对象
